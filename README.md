...
- `/next-problem` to pull the next queued problem by sequence — or
  `/next-problem <name-or-id>` to start a specific one you pick. Then solve it
  entirely in your own IDE/terminal — no agent involvement.
